...
public partial class zuoyeqingkuang : System.Web.UI.Page
{
    ...
    {
        int b = 0;
        string a = ((Label)GridView1.Rows[e.NewEditIndex].Cells[6].FindControl("labwork")).Text;
        if (a == "是")
        {
            b = 0;
        }
        ...
        Inquire();
        DropDownList dll = (DropDownList)GridView1.Rows[e.NewEditIndex].Cells[6].FindControl("dropwork");
        dll.SelectedIndex = b;
    }
    ...
    protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        string strUserRole = ((DropDownList)(GridView1.Rows[e.RowIndex].Cells[6].FindControl("dropwork"))).SelectedItem.ToString();
