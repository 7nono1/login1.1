<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="zuoyeqingkuang.aspx.cs" Inherits="zuoyeqingkuang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="jscxcon1"  ><asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="是否布置作业">
                <ItemTemplate>
                    <asp:Label ID="labwork" runat="server" Text='<%# Bind("布置作业") %>'></asp:Label>
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:DropDownList ID="dropwork" runat="server">
