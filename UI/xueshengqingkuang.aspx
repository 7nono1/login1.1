<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.master" AutoEventWireup="true" CodeFile="xueshengqingkuang.aspx.cs" Inherits="xueshengqingkuang" %>
    ...
    <div class="jscxcon1"  ><asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="出勤">
                <ItemTemplate>
                    <asp:Label ID="chuqinlab" runat="server" Text='<%# Bind("出勤") %>'></asp:Label>
                </ItemTemplate>
                <EditItemTemplate>
                    <asp:DropDownList ID="chuqindrop" runat="server">
